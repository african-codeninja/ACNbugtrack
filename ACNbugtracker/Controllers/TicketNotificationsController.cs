...
namespace ACNbugtracker.Controllers
{
    public class TicketNotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,RecipientId,SenderId,Created,Subject,NotificationBoody,Read")] TicketNotification ticketNotification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,RecipientId,SenderId,Created,Subject,NotificationBoody,Read")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {

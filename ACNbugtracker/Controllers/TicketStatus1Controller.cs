...
namespace ACNbugtracker.Controllers
{
    public class TicketStatus1Controller : Controller
    {
        ...
        // GET: TicketStatus1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: TicketStatus1/Create
